    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="font-display text-3xl font-semibold text-foreground text-center">Create your account</h1>
          <p className="text-sm text-muted-foreground mt-2 text-center">Get your personalised meal plan in minutes</p>
        </div>
        ...
        <div className="bg-card rounded-3xl border border-border shadow-card p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-xs text-muted-foreground leading-relaxed pt-1">
              ...
              <Link href="/terms" className="text-primary hover:underline transition-smooth">Terms</Link>
              {" "}and{" "}
              <Link href="/privacy" className="text-primary hover:underline transition-smooth">Privacy Policy</Link>.
            </p>
          </form>
        </div>
